...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-links a { font-size: 13px; font-weight: 500; letter-spacing: 1.5px; text-transform: uppercase; position: relative; padding: 5px 0; }
        ...
        .auth-section {
            ...
            padding-top: 90px; margin-bottom: 50px; position: relative;
        }
        .auth-container {
        ...
        .cs-item { display: flex; align-items: flex-start; gap: 12px; margin-bottom: 20px; font-size: 14px; color: #666666; }
        ...
        .newsletter-form input { flex: 1; padding: 12px 15px; border: 1px solid #eee; border-right: none; outline: none; font-family: var(--font-body); font-size: 14px; background: #fff; color: #333; }
        .newsletter-form button { background: var(--gold); color: #111; border: none; padding: 0 20px; cursor: none; transition: background 0.3s; }
        .footer-bottom { background: #000000; color: #ffffff; text-align: center; padding: 20px; font-size: 13px; position: relative; }
        .back-to-top { position: absolute; right: 40px; bottom: 15px; background: var(--gold); color: #000; border: none; width: 45px; height: 45px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: none; font-size: 18px; transition: transform 0.3s; }
    </style>
</head>
<body>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-col">
                ...
                <div class="cs-item"><i class="far fa-clock"></i><div><p>Monday - Saturday</p><p>10.00 - 17.00 WIB</p></div></div>
                <div class="cs-item"><i class="fas fa-phone-alt"></i><p>0895-7042-D0408</p></div>
                <div class="cs-item"><i class="far fa-envelope"></i><p>caymiramodest@gmail.com</p></div>
            </div>
            <div class="footer-col">

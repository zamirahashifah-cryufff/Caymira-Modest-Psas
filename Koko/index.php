...
<head>
    ...
    <title>Koko - Caymira Modest</title>
...
.koko-hero-text .description span {
    color: var(--gold);
    font-weight: 500;
}
...
.koko-hero-img:nth-child(1) {
    animation: fadeInUp 1s ease 0.5s forwards;
    margin-top: 40px;
}

.koko-hero-img:nth-child(2) {
    animation: fadeInUp 1s ease 0.7s forwards;
    margin-bottom: 40px;
}
...
/* === KOKO COLLECTION SECTION === */
.koko-collection {
    padding: 80px 0;
    position: relative;
}

.koko-collection::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
...
.koko-card:nth-child(1).visible { animation-delay: 0.1s; }
.koko-card:nth-child(2).visible { animation-delay: 0.15s; }
.koko-card:nth-child(3).visible { animation-delay: 0.2s; }
.koko-card:nth-child(4).visible { animation-delay: 0.25s; }
.koko-card:nth-child(5).visible { animation-delay: 0.3s; }
.koko-card:nth-child(6).visible { animation-delay: 0.35s; }
.koko-card:nth-child(7).visible { animation-delay: 0.4s; }
.koko-card:nth-child(8).visible { animation-delay: 0.45s; }
.koko-card:nth-child(9).visible { animation-delay: 0.5s; }
.koko-card:nth-child(10).visible { animation-delay: 0.55s; }
.koko-card:nth-child(11).visible { animation-delay: 0.6s; }
.koko-card:nth-child(12).visible { animation-delay: 0.65s; }
...
.koko-card:hover .koko-img-overlay {
    opacity: 1;
...
?>
        ...
        <div class="footer-content">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="../About-us/aboutus.html">Tentang Kami</a></li>
                    <li><a href="#collection">Koleksi Koko</a></li>
    ...
    <script>
        ...
        // Memeriksa jika bukan perangkat mobile
        if(window.innerWidth > 768) {
            ...
            // Hover effects untuk kursor
            document.querySelectorAll('a, button, .koko-card, .filter-btn, .color-dot, .nav-icons i').forEach(el => {
        ...
        // 4. Scroll Events (Navbar & Scroll to Top)
        ...
        function filterKoko(category, btnElement) {
            ...
            items.forEach(item => {
                item.style.display = 'none'; // Sembunyikan semua dulu
        ...
        // 9. Intersection Observer (Untuk animasi muncul saat di-scroll)
        ...
        document.querySelectorAll('.section-header h2, .section-header p, .koko-card').forEach(el => {
            observer.observe(el);
        });

        // 10. Interaksi Pemilihan Warna (Color Dots)
        document.querySelectorAll('.koko-colors').forEach(container => {
            const dots = container.querySelectorAll('.color-dot');
            
            dots.forEach(dot => {
                dot.addEventListener('click', (e) => {
                    e.stopPropagation(); // Mencegah klik men-trigger kartu utama
        ...
        // 11. Wishlist Button Click Prevention
        document.querySelectorAll('.overlay-btn.wishlist').forEach(btn => {
            btn.addEventListener('click', (e) => {
                e.stopPropagation(); // Cegah toast utama muncul
